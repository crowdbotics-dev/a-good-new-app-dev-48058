...
## Project Structure
    ...
    ├── a_good_new_app_dev_48058  # Django project configurations
...
1. Clone this repo and `cd a_good_new_app_dev_48058`
...
2. Clone this repo and `cd a_good_new_app_dev_48058`
